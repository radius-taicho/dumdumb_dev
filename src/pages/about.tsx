    ...
    <>
      ...
      <div className="mb-16">
        ...
        <div className="prose max-w-none">
          ...
          <p>
            私たちは小さなオンラインショップからスタートし、現在では全国のお客様に愛される日本有数のECサイトへと成長しました。私たちの成功の秘訣は、お客様を第一に考え、常に最高品質のアイテムとサービスを提供し続けることにあります。
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>持続可能性</strong> -
              環境に配慮したアイテム調達と梱包を心がけています。
            </li>
            <li>
              <strong>誠実さ</strong> -
              すべてのビジネス活動において誠実さを大切にしています。
            </li>
            <li>
              <strong>革新</strong> -
              常に新しいアイデアと改善を追求し続けています。
            </li>
          </ul>

          <h2 className="text-2xl font-bold mt-8 mb-4">お客様へのお約束</h2>
          <p>DumDumbでは、すべてのお客様に以下をお約束します：</p>
          <ul>
            <li>最高品質のアイテム</li>
            <li>迅速で安全な配送</li>
            <li>30日間の返品保証</li>
