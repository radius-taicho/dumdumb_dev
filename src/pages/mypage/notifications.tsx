...
const dummyNotifications = [
  {
    ...
    title: "新作グッズが入荷しました",
    content:
      "お気に入りのシリーズの新作グッズが入荷しました。今すぐチェックしましょう！",
    date: "2023-03-10",
    read: false,
    type: "new-item",
  },
  {
    ...
    content: "お気に入りに登録しているアイテムが20%オフになりました。",
    date: "2023-03-08",
    read: false,
    type: "price-change",
  },
  ...
  },
  {
    ...
    content:
      "4月29日から5月7日までゴールデンウィークセールを開催します。最大50%オフをお見逃しなく！",
    date: "2023-03-01",
    read: true,
    type: "sale",
  },
              ...
              <div className="bg-gray-50 p-4 rounded-md mb-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <label
                      htmlFor="notify-price-changes"
                      className="ml-2 text-sm text-gray-700"
                    >
                      お気に入りアイテムの価格変更をお知らせする
                    </label>
                  </div>
                  <div className="flex items-center">
                    <input
                        ...
                        <div>
                          <h3
                            className={`font-medium ${
                              !notification.read ? "text-indigo-800" : ""
                            }`}
                          >
                            {notification.title}
                          </h3>
