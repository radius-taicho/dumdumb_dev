  ...
  const getPaymentTypeDisplay = (method: PaymentMethod) => {
    ...
    switch (type) {
      ...
      case "OTHER":
        return "代金引換";
      default:
        console.log('不明な支払い方法タイプ:', method.type);
        return "不明な支払い方法";
    }
  };
      ...
      default:
        return (
          ...
          >
            <path
              fillRule="evenodd"
              d="M10 2a8 8 0 100 16 8 8 0 000-16zM9 9a1 1 0 012 0v4a1 1 0 11-2 0V9z"
              clipRule="evenodd"
            />
            ...
            {paymentMethods.map((method) => (
              ...
              >
                ...
                <div className="flex items-start mb-4">
                  <div className="mr-3">{getPaymentIcon(method)}</div>
                  <div>
                    <p className="font-semibold">
                      {getPaymentTypeDisplay(method)}
                    </p>
